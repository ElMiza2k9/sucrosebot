    ...
    class extends Player {
        ...
        setEightD(eightdd) {
            if (typeof eightdd !== "boolean") {
                throw new RangeError('Player#setEightD() EightD can only be "true" or "false".');
            }
        ...
        setKaraoke(karaok) {
            if (typeof karaok !== "boolean") {
                throw new RangeError('Player#setKaraoke() Karaoke can only be "true" or "false".');
            }
        ...
        setVibrato(vib) {
            if (typeof vib !== "boolean") {
                throw new RangeError('Player#setVibrato() Vibrato can only be "true" or "false".');
            }
        ...
        setTremolo(trem) {
            if (typeof trem !== "boolean") {
                throw new RangeError('Player#setVibrato() Tremolo can only be "true" or "false".');
            }
